...
def clean_churn_dataset():
    ...
    def create_table():
        import sqlalchemy
        from sqlalchemy import MetaData, Table, Column, Integer, Float, String, DateTime, UniqueConstraint, inspect
        ...
        if not sqlalchemy.inspect(db_engine).has_table(churn_table.name):
